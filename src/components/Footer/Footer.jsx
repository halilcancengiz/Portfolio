        ...
        <div id="footerAreaDark" className="w-100">
          <div className="container h-100 g-0 my-5">
            ...
            >
              ...
              <li id="twitter">
                <a href="https://twitter.com/hllcncngz1" target="Blank" data-toggle="tooltip" data-placement="top" title="Twitter">
                  <i className="fa-brands fa-twitter"></i>
                </a>
              </li>
              <li id="github">
                <a href="https://github.com/hllcncngz" target="Blank" data-toggle="tooltip" data-placement="top" title="Github">
